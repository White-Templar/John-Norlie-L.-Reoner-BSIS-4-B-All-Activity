...
class _AppointmentScreenState extends State<AppointmentScreen> {
  ...
  final _recordsFormKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_currentIndex == 0 ? 'Appointment Booking' : 'Patient Records'),
        centerTitle: true,
        actions: [
          if (_currentIndex == 1 && _patientRecords.isNotEmpty)
            IconButton(
      ...
      drawer: AppNavigation.buildDrawer(context, 'appointment'),
      body: IndexedStack(
        index: _currentIndex,
        children: [
          _buildAppointmentBookingTab(),
  ...
  Widget _buildAppointmentBookingTab() {
    return Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Schedule appointments with date & time pickers',
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          // Submit Button
                          ElevatedButton(
                            onPressed: _submitAppointmentForm,
                            style: ElevatedButton.styleFrom(
                                          ...
                                          children: [
                                            Expanded(
                                              child: ElevatedButton(
                                                onPressed: _isLoading ? null : _submitRecordForm,
                                                style: ElevatedButton.styleFrom(
                                                  padding: const EdgeInsets.symmetric(vertical: 16),
                                                  shape: RoundedRectangleBorder(
                                                    borderRadius: BorderRadius.circular(8),
  ...
  void _submitRecordForm() async {
    if (_recordsFormKey.currentState!.validate()) {
      setState(() {
        _isLoading = true;
      });
