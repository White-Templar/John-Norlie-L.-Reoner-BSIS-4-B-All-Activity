                ...
                child: GridView.count(
                  ...
                  children: [
                    ...
                    _buildMenuCard(
                      context,
                      'Contacts',
                      'View and manage your medical contacts',
                      Icons.contacts,
                      Colors.purple,
                    ...
                    _buildMenuCard(
                      context,
                      'Shopping Cart',
                      'Medical supplies store with Provider state',
                      Icons.shopping_cart,
                      Colors.teal,
                    ...
                    _buildMenuCard(
                      context,
                      'Todo List',
                      'Medical task manager with Provider',
                      Icons.task_alt,
                      Colors.indigo,
                    ...
                    _buildMenuCard(
                      context,
                      'Media Gallery',
                      'Images, videos, and audio player demos',
                      Icons.photo_library,
                      Colors.pink,
                    ...
                    _buildMenuCard(
                      context,
                      'Theme & Icons',
                      'Theme switcher and custom fonts demo',
                      Icons.palette,
                      Colors.amber,
